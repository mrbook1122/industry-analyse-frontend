...
class Guage extends React.Component {
    ...
    componentDidMount() {
        if (document.getElementById('guage')) {
            ...
            chart.guide().html({
                position: ['50%', '95%'],
                html: '<div style="width: 300px;text-align: center;">' + '<p style="font-size: 20px; color: #545454;margin: 0;">负载</p>' + '<p style="font-size: 36px;color: #545454;margin: 0;">' + data[0].value * 10 + '%</p>' + '</div>'
            });
